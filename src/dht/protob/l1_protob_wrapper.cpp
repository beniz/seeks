...
namespace dht
{
  ...
  void l1_protob_wrapper::serialize_to_string(const l1::l1_response *l1r, std::string &str) throw (dht_exception)
   ...
   void l1_protob_wrapper::read_l1_query(const l1::l1_query *l1q,
					    uint32_t &layer_id,
					    uint32_t &fct_id,
   ...
   void l1_protob_wrapper::read_l1_query(const l1::l1_query *l1q,
					    ...
					    DHTKey &nodekey)
     {
       l1_protob_wrapper::read_l1_query(l1q,layer_id,fct_id,
  ...
  void l1_protob_wrapper::deserialize(const std::string &str, l1::l1_query *l1q) throw (dht_exception)
   ...
   /*- responses -*/
   void l1_protob_wrapper::read_l1_response(const l1::l1_response *l1r,
