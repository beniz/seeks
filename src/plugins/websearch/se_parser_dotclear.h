...
#ifndef SE_PARSER_dotclear_H
#define SE_PARSER_dotclear_H
...
{
  class se_parser_dotclear : public se_parser
  {
    public:
      se_parser_dotclear(const std::string &url);
      ~se_parser_dotclear();
    ...
    private:
      ...
      static std::string _dotclear_stupid[2];
  };
